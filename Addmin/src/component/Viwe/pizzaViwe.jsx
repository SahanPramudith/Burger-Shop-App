...
export default function PizzaView() {
    ...
    function updatePost(e) {
        ...
        axios.put(`http://localhost:3000/pizza/updatepizza/${id}`, formdata)
            .then(function (response) {
                return axios.get('http://localhost:3000/pizza/getpizza');
            })
            .then((response) => {
    ...
    function deletePost(id) {
        axios.delete(`http://localhost:3000/pizza/deletepizza/${id}`)
            .then(function (response) {
                return axios.get('http://localhost:3000/pizza/getpizza');
            })
            .then((response) => {
