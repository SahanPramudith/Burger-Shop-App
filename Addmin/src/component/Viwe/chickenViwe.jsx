...
export default function ChikenView() {
    ...
    function updatePost(e) {
        ...
        axios.put(`http://localhost:3000/chicken/updatechicken/${id}`, formdata)
            .then(function (response) {
                return axios.get('http://localhost:3000/chicken/getchicken');
            })
            .then((response) => {
    ...
    function deletePost(id) {
        axios.delete(`http://localhost:3000/chicken/deletechicken/${id}`)
            .then(function (response) {
                return axios.get('http://localhost:3000/chicken/getchicken');
            })
            .then((response) => {
